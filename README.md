...
1. Choose  $\xi$ and $c$ steps. Optionally, adjust the number of workers for parallel processing.
   > **Note:** The optimal number depends on your system’s hardware (available CPU cores and memory). Setting too many workers may reduce performance on systems with limited resources.
